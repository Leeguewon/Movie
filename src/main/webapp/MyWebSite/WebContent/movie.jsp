...
<section id="main">
    <%
        String kobisApiKey = "4c15cd987f06b6d1e0de10660650d11d"; 
        String kmdbApiKey = "W6XJXMN69CV244OE74HS"; 
        
        java.util.Calendar calendar = java.util.Calendar.getInstance();
        calendar.add(java.util.Calendar.DATE, -1);  
        java.text.SimpleDateFormat dateFormat = new java.text.SimpleDateFormat("yyyyMMdd");
        String targetDt = dateFormat.format(calendar.getTime());  
        ...
        try {
            ...
            int endIndex = Math.min(startIndex + 5, dailyBoxOfficeList.length()); 
         ...
         // 기본 이미지 배열
					...
					String[] defaultImages = {
						"http://kobis.or.kr/common/mast/movie/2024/11/thumb_x640/thn_daa22403cbc0415bab24f8616f906f60.jpg", // 3번째 기본 이미지
						"http://kobis.or.kr/common/mast/movie/2024/10/thumb_x640/thn_6d0b52dc03b742b5a081a9e53beba8d9.jpg", // 4번째 기본 이미지
            ...
            // 기본 이미지 선택 방식 수정 (startIndex 기반으로 순차적으로 기본 이미지 할당)
            for (int i = startIndex; i < endIndex; i++) {
                ...
                try {
                    ...
                    if (data.length() > 0) {
                        ...
                        if (resultList.length() > 0) {
                            ...
                            String posters = movieData.optString("posters"); 
                            if (!posters.isEmpty()) {
                ...
                out.println("<div class='movie-item' style='text-align: center;'>");
                out.println("<h3 class='movie-title' style='color: white;'>" + rank + ". " + movieNm + "</h3>"); // 추가된 클래스
                ...
                if (!posterUrl.isEmpty()) {
                    ...
                    String selectedImage = defaultImages[(i - startIndex) % defaultImages.length];
            ...
            int totalPages = (int) Math.ceil(dailyBoxOfficeList.length() / 5.0);
            out.println("<div class='pagination'>");

            String previousButton = (pageNum > 1) ? "<a href='?page=" + (pageNum - 1) + "' class='pagination-btn'> < </a>" : "";
            String nextButton = (pageNum < totalPages) ? "<a href='?page=" + (pageNum + 1) + "' class='pagination-btn'> > </a>" : "";
            
            out.println(previousButton + " 페이지 " + pageNum + " of " + totalPages + " " + nextButton);
